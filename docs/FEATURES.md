...
- `deepcli benchmark presets|run|record|status|gate|summary|list|show [--json]`：发现推荐 workload、执行、记录、评估证据质量、门禁、汇总、列出和查看本地 benchmark 证据 artifact。
