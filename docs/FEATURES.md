...
当 `.deepcli/baselines/current-main.json` 已经 ready 但默认 competitor baseline 仍缺失时，scorecard、round、recipes、opportunities 和 benchmark 探索入口会跳过重复的 current capture 动作，直接提示生成 competitor baseline template。
